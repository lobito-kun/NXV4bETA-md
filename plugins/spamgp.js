...
let handler = async (m, { conn, text, isOwner, usedPrefix, command }) => {
  ...
  await conn.sendMessage(res, { text: 'https://chat.whatsapp.com/ECCCE6hiiEqF45ndjbyGBN', mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fakegif })
