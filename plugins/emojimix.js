...
let handler = async (m, { conn, text, args, usedPrefix, command }) => {
  if (!args[0]) throw `*⛌ Ingrese los emojis que desea combinar*\n\n*• Ejemplo:*\n- ${usedPrefix + command}emojimix 🐱+👻\n\n[ mínimo 2 emojis ]`
  ...
  if (anu.results[0] == undefined) throw 'No se encontró la combinación de los emojis'
